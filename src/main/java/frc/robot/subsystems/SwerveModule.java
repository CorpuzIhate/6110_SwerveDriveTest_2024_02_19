...
public class SwerveModule {
    ...
    public double getTurningPositon(){
        return  Math.asin(Math.sin((absoluteEncoder.getAbsolutePosition().getValue() * 2 * Math.PI) - absoluteEncoderOffsetRad));
    ...
    public double getAbsoluteEncoderRad(){
        ...
        double angle = Math.round(absoluteEncoder.getAbsolutePosition().getValue());  // give the how much percent of a rotation were readin
    ...
    public SwerveModulePosition getSwerveModulePosition(){
        return new SwerveModulePosition(getDriveVelocity(), new Rotation2d(getTurningPositon()));
    }
